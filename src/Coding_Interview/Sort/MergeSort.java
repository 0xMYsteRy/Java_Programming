...
Divide the input array into two halves until it cannot be divide.
Then merge the two sorted halves.

2 functions will be used in this algorithm.
The mergeSort() function will be recursively called itself to divide the array till the size become one.
The merge function() is used for merging two halves.
 */
public class MergeSort {
    static  int  arr[]={-50,67,9,30,5,75,40};
